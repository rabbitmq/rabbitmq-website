...
# Using a password hash is preferred for security
...
Starting with RabbitMQ `4.0.21` (a release available to customers with a commercial support license),
passive declarations require the user to have **at least one permission**
