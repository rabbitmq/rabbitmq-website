...
<figure>
![Unroutable message metrics](./mgmt-ui-unroutable-message-metrics.png)
</figure>
...
Client libraries may also collect metrics. [RabbitMQ Java client](/client-libraries/java-api-guide#metrics) is one
...
Such failures are [logged](./logging) by RabbitMQ as errors.
...
<figure>
![An exchange without bindings](./mgmt-ui-exchange-without-bindings.png)
</figure>
