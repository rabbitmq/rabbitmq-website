...
RabbitMQ 4.2 requires feature flags introduced in the 3.13 series to be enabled prior to the upgrade,
RabbitMQ 4.3 will require all feature flags from 4.2 to be enabled, and so on.
:::
