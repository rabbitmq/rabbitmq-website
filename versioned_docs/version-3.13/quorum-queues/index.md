...
3. With larger messages, the [number of entries per segment file](#segment-entry-count) should be **significantly** reduced
   to reduce the segment file and allow for more frequent truncation (removal) of those files
