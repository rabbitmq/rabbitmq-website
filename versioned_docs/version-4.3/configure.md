...
<div>
  ...
  <tr>
    ...
    <td>
      Has no effect starting with RabbitMQ `4.3.0`.

      See the [documentation on partitions](./partitions) for more information.
...
or any values in `rabbitmq-env-conf.bat` have changed. Environment variables used by
