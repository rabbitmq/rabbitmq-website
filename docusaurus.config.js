...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      announcementBar: {
        id: 'new-release',
        content: '<strong style="font-size: var(--ifm-h4-font-size);"><a href="https://github.com/rabbitmq/rabbitmq-server/releases/tag/v3.13.2">RabbitMQ 3.13.2 is released!</a></strong>',
