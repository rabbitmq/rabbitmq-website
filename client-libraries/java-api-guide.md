...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <code>5671</code> for <a href="/docs/ssl">connections that use TLS</a>
    </td>
  </tr>
</table>
...
Alternatively, [URIs](/docs/uri-spec) may be used:
...
Client [connections](/docs/connections) are meant to be long-lived. The underlying protocol is designed and optimized for
...
### Atomicity and use of the isOpen() method {#shutdown-atomicity}
