...
In the [last post](/posts/2020/06/cluster-sizing-case-study-quorum-queues-part-1) we started a sizing analysis of our [workload](/posts/2020/06/cluster-sizing-and-other-considerations) using quorum queues. We focused on the happy scenario that consumers are keeping up meaning that there are no queue backlogs and all brokers in the cluster are operating normally. By running a series of benchmarks modelling our workload at different intensities we identified the top 5 cluster size and storage volume combinations in terms of cost per 1000 msg/s per month.
