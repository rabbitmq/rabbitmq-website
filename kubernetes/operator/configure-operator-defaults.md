...
Also see [`cluster-operator/docs/examples`](https://github.com/rabbitmq/cluster-operator/tree/main/docs/examples), including:
* [modification of default resource requests and limits](https://github.com/rabbitmq/cluster-operator/blob/main/docs/examples/resource-limits/rabbitmq.yaml)
