...
The OAuth 2.0 introspection endpoint, defined in RFC 7662, requires authentication. This authentication is typically achieved using client credentials, which can be provided via Basic Authentication (BA) or as POST parameters (client_id and client_secret).
