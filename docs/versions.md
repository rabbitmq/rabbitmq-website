...
<table class="release-series">
  ...
  <tr>
    <td>3.10</td>
    <td><a href={`https://github.com/rabbitmq/rabbitmq-server/releases/tag/${RabbitMQServerGitTag({branch: '3.10'})}`} target="_blank" rel="noopener noreferrer">{RabbitMQServerVersion({branch: '3.10'})}</a></td>
