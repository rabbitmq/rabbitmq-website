...
For Debian, this means that the RabbitMQ core team's packaging focus is on the current and prior release of Debian-based distributions,
in line with the [Debian distribution EOL policy](https://wiki.debian.org/DebianReleases).
...
To determine the exact version string to use for pinning (including any package epoch), consult `apt-cache policy`:
...
Aug 26 10:21:30 localhost.localdomain rabbitmq-server[957]: ##  ##      RabbitMQ 4.2.5. Copyright (c) 2005-2026 Broadcom. All Rights Reserved. The term "Broadcom" refers to Broadcom Inc. and/or its subsidiaries.
...
Aug 26 11:03:04 localhost rabbitmq-server[968]: ##  ##      RabbitMQ 4.2.5. Copyright (c) 2005-2026 Broadcom. All Rights Reserved. The term "Broadcom" refers to Broadcom Inc. and/or its subsidiaries.
