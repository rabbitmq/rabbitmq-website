  ...
  return (
    <Layout title={`${siteConfig.tagline}`}>
      <Head>
        ...
        <link type="text/css" rel="stylesheet" href="https://content.cdntwrk.com/css/hubs/embed_collection.962e852f43ea870438cb.css"></link>
        <script src="https://content.cdntwrk.com/js/hubs/embed_libs.962e852f43ea870438cb.js"></script>
        <script src="https://content.cdntwrk.com/js/hubs/embed_app.962e852f43ea870438cb.js"></script>
        <script id="injected-js-1702546125502" src="https://content.pivotal.io/hubsFront/embedded_loadInitial/453624/1/3/0/1/2541bf7b-b024-4b81-b04f-0d736def0fbb"></script>
      </Head>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.columns}>
              ...
              <div className={[styles.column, styles.fifty].join(' ')}>
                <div className={styles.inner}>
                  <div className={styles.container}>
                    <a className={[styles.btn, styles.orangebtn].join(' ')} href="/docs/getstarted">RabbitMQ Tutorials</a>
