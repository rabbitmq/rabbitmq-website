        ...
        <div className={styles.hero}>
          <div className={[styles.container, styles.heroInner].join(' ')}>
            ...
            <div class={styles.heroCta}>
              ...
              <Link className={styles.release_notes_link} to="https://github.com/rabbitmq/rabbitmq-server/releases/tag/v4.1.3">RabbitMQ 4.1.3</Link>
            </div>
          </div>
        </div>
            ...
            <div className={styles.flex_columns}>
              <section>
                ...
                <p>
                    Free under the
                    {' '}
                    <Link to="https://www.tldrlegal.com/license/mozilla-public-license-2-0-mpl-2">Mozilla Public License 2.0</Link>
                    , it’s backed by a vibrant global community. Dive in with our easy-to-use
                    {' '}
                    <Link to="/docs">docs</Link> or <Link to="/github">contribute</Link>
                    {' '}
                    to shape its future!
                </p>
              </section>
