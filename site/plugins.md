...
e.g. `/usr/lib/rabbitmq/lib/rabbitmq_server-3.8.3/plugins`. Because of this
...
PLUGINS_DIR="/usr/lib/rabbitmq/plugins:/usr/lib/rabbitmq/lib/rabbitmq_server-3.8.3/plugins"
</pre>
...
PLUGINS_DIR="C:\Example\RabbitMQ\plugins;C:\Example\RabbitMQ\rabbitmq_server-3.8.3\plugins"
</pre>
...
# => {ok,"/usr/lib/rabbitmq/plugins:/usr/lib/rabbitmq/lib/rabbitmq_server-3.8.3/plugins"}
</pre>
