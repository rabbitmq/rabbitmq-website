...
25824 / 26398 provide a mechanism to apportion binary memory use
25850 prevent excessive binary memory use when accepting or delivering
      large messages at high speed
...
26192 improve usability of "rabbitmqctl remove_cluster_node --offline" by
      not requiring the user to start a NODE_ONLY node
...
25470 provide UI to choose series to show in charts
...
26193 display locations of interesting files management
...
25824 provide a mechanism to apportion binary memory use
...
26382 allow visible columns to be changed in the web UI
...
25525 allow Subscripotion class to set explicit consumer tag
