...
RabbitMQ `3.9.0-beta.2` is a preview of a new minor release. It contains new features,
...
3.9.x-specific features can only be made available when all nodes in the cluster upgrade to 3.9.0.
