...
RabbitMQ `3.9.0` is a minor (feature) release. It contains a new persistent and replicated data structure called [Streams](https://blog.rabbitmq.com/posts/2021/07/rabbitmq-streams-overview/), [support for Erlang 24](https://blog.rabbitmq.com/posts/2021/03/erlang-24-support-roadmap/), improved integration with our [RabbitMQ Kubernetes Operator](https://blog.rabbitmq.com/posts/2020/11/rabbitmq-kubernetes-operator-reaches-1-0/), and important internal changes in a number of subsystems.
