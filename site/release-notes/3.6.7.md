...
See the ["Upgrading clusters" section of the documentation](http://www.rabbitmq.com/clustering.html#upgrading) and a note at the end of this release notes document for general documentation on upgrades.
...
(see [Debian installation guide](http://www.rabbitmq.com/install-debian.html) and [RPM installation guide](http://www.rabbitmq.com/install-rpm.html)).
