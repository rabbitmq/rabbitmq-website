...
This release [requires Erlang/OTP 22](https://www.rabbitmq.com/which-erlang.html) or
[Erlang 23](http://blog.erlang.org/OTP-23-Highlights/).

Erlang 21.3 [**ios no longer supported**](https://groups.google.com/forum/#!topic/rabbitmq-users/v3K5nZNsfwM).
 ...
 * `cowboy` was upgraded [from 2.6.1 to 2.8.0](https://ninenines.eu/articles/cowboy-2.8.0/)
