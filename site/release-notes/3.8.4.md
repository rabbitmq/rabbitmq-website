 ...
 * Allow product name, version & MOTD to be overwritten via environment variables.

   GitHub issue: [rabbitmq/rabbitmq-server#2247](https://github.com/rabbitmq/rabbitmq-server/pull/2247)

 * Improve display of product name & version.
 ...
 * Emit a consumer.created event for quorum queues.
   ...
   GitHub issue: [rabbitmq/rabbitmq-server#2342](https://github.com/rabbitmq/rabbitmq-server/issues/2341)
 ...
 * New rabbitmq-upgrade commands that waits for a quorum + 1 of nodes to be online within a period of time.
 ...
 * prometheus.erl was upgraded [from v4.5.0 to v4.6.0](https://github.com/deadtrickster/prometheus.erl/compare/v4.5.0...v4.6.0)
