...
RabbitMQ `3.8.4-rc.2` is a preview of a maintenance release. It focuses on bug fixes and usability
...
This is also the first release since the GA availability of [Erlang 23](http://blog.erlang.org/OTP-23-Highlights/).
